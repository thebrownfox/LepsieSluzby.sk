          ...
          <fieldset class="govuk-fieldset">
            <div class="govuk-form-group">
              ...
              <span class="govuk-error-message">
                <span class="govuk-visually-hidden">Error:</span> Toto pole je
                povinné.
              </span>
            </div>
            ...
            <div class="govuk-form-group">
              ...
              <input
                ...
                @blur="
                  valid.email =
                    form.email === '' || validInput(form.email, 'email')
                "
              />
              <span class="govuk-error-message">
                <span class="govuk-visually-hidden">Error:</span> Email je v
                nesprávnej forme.
              </span>
            </div>
...
export default {
    ...
    subCategories: function() {
      ...
      if (persona && persona !== "Žiadne") {
        ...
        if (this.categories.persona[index].children) {
          options = options.concat(this.categories.persona[index].children);
        }
      }
      return options;
    }
  ...
  methods: {
    ...
    logout: async function() {
      const logoutURL = "https://lepsiesluzby.sk/jira/rest/auth/1/session";
      try {
    ...
    postData: async function(inputData) {
      ...
      try {
        ...
        if (this.form.files && post) {
          try {
            const attachmentURL = post.data.self + "/" + "attachments";
    ...
    submitForm: function() {
      ...
      if (data.categories.persona && data.categories.persona !== "Žiadne") {
