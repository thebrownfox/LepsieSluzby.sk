...
var _default = {
  ...
  computed: {
    tableData: function tableData() {
      ...
      if (jiraData) {
        ...
        var categoryName = function categoryName(issue) {
          if (issue && issue.fields && issue.fields.customfield_10204) {
            if (issue.fields.customfield_10204.child) {
              return "".concat(issue.fields.customfield_10204.value, " - ").concat(issue.fields.customfield_10204.child.value);
            } else {
              return "".concat(issue.fields.customfield_10204.value);
            }
          }
  ...
  methods: {
    getJiraData: function () {
      var _getJiraData = (0, _asyncToGenerator2.default)(
      /*#__PURE__*/
      _regenerator.default.mark(function _callee() {
        var searchURL, params, response;
        return _regenerator.default.wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                searchURL = "https://lepsiesluzby.sk/jira/rest/api/2/search";
                params = {
                  jql: "project = SDM  AND component = e-services ORDER BY created DESC",
      ...
      function getJiraData() {
        return _getJiraData.apply(this, arguments);
      }
      ...
      return _regenerator.default.wrap(function _callee2$(_context2) {
        while (1) {
          switch (_context2.prev = _context2.next) {
            case 0:
              _context2.next = 2;
              return this.getJiraData();

            case 2:
              this.jiraData = _context2.sent;
...
exports.default = _default;
        var $be342a = exports.default || module.exports;
      
      if (typeof $be342a === 'function') {
        $be342a = $be342a.options;
      }
    
        /* template */
        Object.assign($be342a, (function () {
          var render = function() {
  var _vm = this
    ...
    [
      ...
      _c("div", { staticClass: "govuk-width-container" }, [
        _c(
          ...
          [
            _c("div", { staticClass: "govuk-grid-row" }, [
              _c(
                "div",
                {
                  staticClass:
                    "govuk-grid-column-three-quarters govuk-!-padding-bottom-6"
                },
                [_c("nd-thumbnail", { attrs: { url: "/podnet" } })],
                1
              )
            ]),
            _vm._v(" "),
    ...
    (function () {
      if (module.hot) {
        ...
        if (api.compatible) {
          module.hot.accept();
          if (!module.hot.data) {
            api.createRecord('$be342a', $be342a);
          } else {
            api.reload('$be342a', $be342a);
          }
        }
...
//# sourceMappingURL=/home.6c0e0ed2.js.map