...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"views/projekt.vue":[function(require,module,exports) {
"use strict";
...
exports.default = _default;
        var $a5a6ca = exports.default || module.exports;
      
      if (typeof $a5a6ca === 'function') {
        $a5a6ca = $a5a6ca.options;
      }
    
        /* template */
        Object.assign($a5a6ca, (function () {
          var render = function() {
  var _vm = this
    ...
    (function () {
      if (module.hot) {
        ...
        if (api.compatible) {
          module.hot.accept();
          if (!module.hot.data) {
            api.createRecord('$a5a6ca', $a5a6ca);
          } else {
            api.reload('$a5a6ca', $a5a6ca);
          }
        }
...
//# sourceMappingURL=/projekt.89cdc4cd.js.map